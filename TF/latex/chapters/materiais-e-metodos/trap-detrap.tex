...
\myworries{colocar o que eu usei no final - provalvemente sem o 4pi}

\myworries{Para efeito desse trabalho, com o objetivo de desenvolver um modelo simples, foram considerados os seguintes valores para $k_t$ e $k_d$: //completar}
\subsection{Condições de Contorno}
\label{sec:trap-detrap-cc}
\myworries{isso aqui deve entrar no outro topico e ser mais mencionado aqui}
