...
Sendo assim, pode-se reescrever a eq.(\ref{eq:oc-to-m3}) como:
...
$C_{eq}$ & Concentração de equilíbrio entre gás e aço &  33.805 mol/m$^3$ (2,0358 $\times$ 10$^{28}$ m$^{-3}$)   \\
\hline\hline
\end{tabular}
\label{tab:parametros_cscte}
}
}
\end{table}
