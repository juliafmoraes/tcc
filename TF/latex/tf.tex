...
%e testando a dependência do coeficiente de difusão em relação à concentração (seção\ref{sec:modelo22}).
...
\myworries{fazer uma tabela com entradas do sommers/galdikas}
