...
% ========== Opções do documento ==========
% Título
\titulo{P4 - Revisão Bibliográfica}
...
Aonde $\eta = Axt^m = \frac{1}{\sqrt{4D}}xt^{-1/2} = \frac{x}{2\sqrt{Dt}}$.
...
\end{equation}
%
%Para o caso em que $c = \frac{c_s + c_i}{2}$:
%
%\begin{center}
%	\begin{equation} 
%		\begin{array}
%		\frac{c - c_i}{c_s - c_i} = \frac{1}{2}  \Rightarrow 1 - erf(\frac{x}{2\sqrt{Dt}}) = \frac{1}{2} \Rightarrow erf(\frac{x}{2\sqrt{Dt}}) = \frac{1}{2} \Rightarrow \frac{x}{2\sqrt{Dt}}   = \frac{1}{2} \\
%		\therefore x \simeq \sqrt{Dt}
%		\end{array}
%	\end{equation}
%\end{center}
%	
