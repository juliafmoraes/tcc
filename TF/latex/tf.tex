...
% ========== Opções do documento ==========
% Título
\titulo{Análise numérica da difusão de nitrogênio em aços inoxidáveis austeníticos}
...
%\myworries{ATUALIZAR A CATALOGACAO}



% ========== Dedicatória (opcional) ==========
\dedicatoria{Dedico esse trabalho a todos que me apoiaram nos últimos anos}


% ========== Agradecimentos ==========
\begin{agradecimentos}

\input{chapters/outros/agradecimentos}
...
% ========== Epígrafe (opcional) ==========
\epigrafe{%
	\emph{``I can’t do what I do alone, and I need something from everybody. The only thing I know how to do is sketch and come up with a few ideas, but for the rest of it, I need help.''}
	\begin{flushright}
		(Karl Lagerfeld)
	\end{flushright}
}
...
% ========== Abstract ==========
\begin{abstract}
\input{chapters/outros/abstract}
%
\\[3\baselineskip]
%
...
% ========== Elementos textuais ==========
\chapter{Introdução}
\input{chapters/outros/introducao}
...
\label{sec:dif-fin}
\input{chapters/materiais-e-metodos/diferencas-finitas}

\subsection{Algoritmo de Thomas}	
\label{sec:algo-thomas}
\input{chapters/materiais-e-metodos/algoritmo-de-thomas}
...
\input{chapters/materiais-e-metodos/sol-numerica-2alei}
...
\input{chapters/materiais-e-metodos/sol-numerica-2alei-gas}
\input{chapters/materiais-e-metodos/sol-numerica-2alei-plasma}
...
\input{chapters/materiais-e-metodos/trap-detrap}

\subsection{Discretização}
\input{chapters/materiais-e-metodos/trap-detrap-Dcte}
...
\input{chapters/parametros-e-constantes/parametros}
...
\label{sec:modelo11}
\input{chapters/resultados/sol-numerica-2alei-cscte}
...
\label{sec:modelo12}
\input{chapters/resultados/sol-numerica-2alei-csvar}
...
\subsection{Concentração na superfície constante}
\label{sec:modelo21}
\input{chapters/resultados/trap-detrap-cscte}

\subsection{Nitretação Gasosa}
\label{sec:modelo22}
\input{chapters/resultados/trap-detrap-gas}

\subsection{Nitretação a Plasma}
\label{sec:modelo23}
\input{chapters/resultados/trap-detrap-plasma}
...
\input{chapters/discussao/analise-resultados}
...
\chapter{Conclusões}
\input{chapters/outros/conclusao}
...
\chapter*{Apêndice}
\input{chapters/outros/anexos}
\input{chapters/outros/apendiceB}
