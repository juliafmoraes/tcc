...
\dedicatoria{Dedico esse trabalho ao meu avô e ao meu pai}
...
\\[3\baselineskip]
%
\textbf{Palavras-Chave} -- Nitretação, Difusão de nitrogênio, Aço inoxidável austenítico, Modelamento matemático, Difusão de nitrogênio, Austenita expandida.
\end{resumo}
