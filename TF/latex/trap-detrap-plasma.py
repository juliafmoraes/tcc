...
class TrapDetrap(Simulation):
    def __init__(self, dt, dx, T, n, temperature, trap_concentration, host_atom_concentration, detrapping_energy,
                 diffusion_energy, capture_radius, D_zero, c_eq, j, host_surface_concentration):
        ...
        self.host_surface_concentration = host_surface_concentration  # at/m2
        ...
        for j in range(self.iterations + 1):
            ...
            if j * dt in [60.0, 600.0, 1800.0] or j * dt % 3600 == 0:
                writer = pd.ExcelWriter(
                    r"{}\trapDetrapPlasma_{}.xlsx".format(outdir, j * dt))
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Trapping-Detrapping - Plasma Nitriding boundary')
